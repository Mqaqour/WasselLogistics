        ...
        <div className="py-16 sm:py-24 overflow-hidden min-h-[600px]">
            ...
            <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 animate-enter">
                ...
                <div className="relative max-w-7xl mx-auto group">
                    {/* Controls */}
                    <button onClick={prevSlide} className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 lg:-ml-12 z-20 bg-white/10 hover:bg-corp-secondary hover:text-corp-primary text-white p-3 rounded-full backdrop-blur-md transition-all border border-white/20 shadow-xl hidden md:block">
                        <ChevronLeft className="w-8 h-8 rtl:rotate-180" />
                    </button>
                    <button onClick={nextSlide} className="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 lg:-mr-12 z-20 bg-white/10 hover:bg-corp-secondary hover:text-corp-primary text-white p-3 rounded-full backdrop-blur-md transition-all border border-white/20 shadow-xl hidden md:block">
                    ...
                    <div className="flex justify-between items-center mt-6 md:hidden px-4">
                        <button onClick={prevSlide} className="bg-white/10 p-3 rounded-full text-white hover:bg-corp-secondary hover:text-corp-primary transition-colors"><ChevronLeft className="w-6 h-6 rtl:rotate-180" /></button>
                        ...
                        <button onClick={nextSlide} className="bg-white/10 p-3 rounded-full text-white hover:bg-corp-secondary hover:text-corp-primary transition-colors"><ChevronRight className="w-6 h-6 rtl:rotate-180" /></button>
                    </div>
                </div>
            </div>
        </div>
