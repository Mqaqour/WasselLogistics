...
BEGIN
    INSERT INTO [dbo].[resource_categories] (code, title_ar, title_en, description_ar, description_en, image_url, sort_order, is_active) VALUES
      (N'services',          N'الخدمات',              N'Services',                    N'تعرّف على جميع خدمات الشحن والخدمات اللوجستية المتاحة للأفراد والشركات.',    N'Explore all shipping and logistics services available for individuals and businesses.',  N'/assets/projects/services.png',          1,  1),
      (N'shipping-guides',   N'أدلة الشحن',           N'Shipping Guides',             N'أدلة خطوة بخطوة لمساعدتك في تجهيز الشحنات وطلبها وتسليمها بسهولة.',        N'Step-by-step guides to help you prepare, book, and deliver shipments smoothly.',         N'/assets/projects/shipping-guides.png',   2,  1),
      ...
      (N'packaging',         N'التغليف',              N'Packaging',                   N'أفضل الممارسات لتغليف الشحنات بشكل آمن واحترافي.',                           N'Best practices for packing shipments safely and professionally.',                        N'/assets/projects/packaging.png',         4,  1),
      (N'prohibited-items',  N'المواد المحظورة',      N'Prohibited & Restricted Items',N'اطّلع على المواد الممنوعة والمقيّدة قبل إنشاء شحنتك.',                    N'Check restricted and prohibited items before creating your shipment.',                   N'/assets/projects/prohibited-items.png',  5,  1),
      (N'customs-clearance', N'الجمارك والتخليص',     N'Customs & Clearance',         N'كل ما يتعلق بالمستندات الجمركية والرسوم ومتطلبات التخليص.',                 N'Everything related to customs paperwork, duties, and clearance requirements.',           N'/assets/projects/customs-clearance.png', 6,  1),
      (N'accounts-payments', N'الحسابات والدفع',      N'Accounts & Payments',         N'معلومات عن الحسابات والفوترة وطرق الدفع والإجراءات المالية.',               N'Information about accounts, invoicing, payment methods, and financial processes.',       N'/assets/projects/accounts-payments.png', 7,  1),
      (N'policies-terms',    N'السياسات والشروط',     N'Policies & Terms',            N'راجع السياسات التشغيلية وشروط الخدمة والتزامات العميل.',                    N'Review the operational policies, service terms, and customer obligations.',              N'/assets/projects/policies-terms.png',    8,  1),
